...
int ngpgfx_StateAction(ngpgfx_t *gfx, void *data, int load, int data_only)
{
   ...
   SFORMAT StateRegs[] =
   {
      ...
      { &(gfx->S1SO_H), SF_IS_BOOL(&(gfx->S1SO_H)) ? 1 : sizeof(gfx->S1SO_H), 0x80000000 | (SF_IS_BOOL(&(gfx->S1SO_H)) ? 0x08000000 : 0), "S1SO_H" },
      { &(gfx->S1SO_V), SF_IS_BOOL(&(gfx->S1SO_V)) ? 1 : sizeof(gfx->S1SO_V), 0x80000000 | (SF_IS_BOOL(&(gfx->S1SO_V)) ? 0x08000000 : 0), "S1SO_V" },
      { &(gfx->S2SO_H), SF_IS_BOOL(&(gfx->S2SO_H)) ? 1 : sizeof(gfx->S2SO_H), 0x80000000 | (SF_IS_BOOL(&(gfx->S2SO_H)) ? 0x08000000 : 0), "S2SO_H" },
      { &(gfx->S2SO_V), SF_IS_BOOL(&(gfx->S2SO_V)) ? 1 : sizeof(gfx->S2SO_V), 0x80000000 | (SF_IS_BOOL(&(gfx->S2SO_V)) ? 0x08000000 : 0), "S2SO_V" },
      { &(gfx->WBA_H), SF_IS_BOOL(&(gfx->WBA_H)) ? 1 : sizeof(gfx->WBA_H), 0x80000000 | (SF_IS_BOOL(&(gfx->WBA_H)) ? 0x08000000 : 0), "WBA_H" },
      { &(gfx->WBA_V), SF_IS_BOOL(&(gfx->WBA_V)) ? 1 : sizeof(gfx->WBA_V), 0x80000000 | (SF_IS_BOOL(&(gfx->WBA_V)) ? 0x08000000 : 0), "WBA_V" },
      { &(gfx->WSI_H), SF_IS_BOOL(&(gfx->WSI_H)) ? 1 : sizeof(gfx->WSI_H), 0x80000000 | (SF_IS_BOOL(&(gfx->WSI_H)) ? 0x08000000 : 0), "WSI_H" },
      { &(gfx->WSI_V), SF_IS_BOOL(&(gfx->WSI_V)) ? 1 : sizeof(gfx->WSI_V), 0x80000000 | (SF_IS_BOOL(&(gfx->WSI_V)) ? 0x08000000 : 0), "WSI_V" },
      { &(gfx->C_OVR), SF_IS_BOOL(&(gfx->C_OVR)) ? 1 : sizeof(gfx->C_OVR), 0x80000000 | (SF_IS_BOOL(&(gfx->C_OVR)) ? 0x08000000 : 0), "C_OVR" },
      { &(gfx->BLNK), SF_IS_BOOL(&(gfx->BLNK)) ? 1 : sizeof(gfx->BLNK), 0x80000000 | (SF_IS_BOOL(&(gfx->BLNK)) ? 0x08000000 : 0), "BLNK" },
      { &(gfx->PO_H), SF_IS_BOOL(&(gfx->PO_H)) ? 1 : sizeof(gfx->PO_H), 0x80000000 | (SF_IS_BOOL(&(gfx->PO_H)) ? 0x08000000 : 0), "PO_H" },
      { &(gfx->PO_V), SF_IS_BOOL(&(gfx->PO_V)) ? 1 : sizeof(gfx->PO_V), 0x80000000 | (SF_IS_BOOL(&(gfx->PO_V)) ? 0x08000000 : 0), "PO_V" },
      { &(gfx->P_F), SF_IS_BOOL(&(gfx->P_F)) ? 1 : sizeof(gfx->P_F), 0x80000000 | (SF_IS_BOOL(&(gfx->P_F)) ? 0x08000000 : 0), "P_F" },
      { &(gfx->BG_COL), SF_IS_BOOL(&(gfx->BG_COL)) ? 1 : sizeof(gfx->BG_COL), 0x80000000 | (SF_IS_BOOL(&(gfx->BG_COL)) ? 0x08000000 : 0), "BG_COL" },
      { &(gfx->CONTROL_2D), SF_IS_BOOL(&(gfx->CONTROL_2D)) ? 1 : sizeof(gfx->CONTROL_2D), 0x80000000 | (SF_IS_BOOL(&(gfx->CONTROL_2D)) ? 0x08000000 : 0), "CONTROL_2D" },
      { &(gfx->CONTROL_INT), SF_IS_BOOL(&(gfx->CONTROL_INT)) ? 1 : sizeof(gfx->CONTROL_INT), 0x80000000 | (SF_IS_BOOL(&(gfx->CONTROL_INT)) ? 0x08000000 : 0), "CONTROL_INT" },
      { &(gfx->SCREEN_PERIOD), SF_IS_BOOL(&(gfx->SCREEN_PERIOD)) ? 1 : sizeof(gfx->SCREEN_PERIOD), 0x80000000 | (SF_IS_BOOL(&(gfx->SCREEN_PERIOD)) ? 0x08000000 : 0), "SCREEN_PERIOD" },
      { &(gfx->K2GE_MODE), SF_IS_BOOL(&(gfx->K2GE_MODE)) ? 1 : sizeof(gfx->K2GE_MODE), 0x80000000 | (SF_IS_BOOL(&(gfx->K2GE_MODE)) ? 0x08000000 : 0), "K2GE_MODE" },
      ...
      { &(gfx->winx), SF_IS_BOOL(&(gfx->winx)) ? 1 : sizeof(gfx->winx), 0x80000000 | (SF_IS_BOOL(&(gfx->winx)) ? 0x08000000 : 0), "winx" },
      { &(gfx->winw), SF_IS_BOOL(&(gfx->winw)) ? 1 : sizeof(gfx->winw), 0x80000000 | (SF_IS_BOOL(&(gfx->winw)) ? 0x08000000 : 0), "winw" },
      { &(gfx->winy), SF_IS_BOOL(&(gfx->winy)) ? 1 : sizeof(gfx->winy), 0x80000000 | (SF_IS_BOOL(&(gfx->winy)) ? 0x08000000 : 0), "winy" },
      { &(gfx->winh), SF_IS_BOOL(&(gfx->winh)) ? 1 : sizeof(gfx->winh), 0x80000000 | (SF_IS_BOOL(&(gfx->winh)) ? 0x08000000 : 0), "winh" },
      { &(gfx->scroll1x), SF_IS_BOOL(&(gfx->scroll1x)) ? 1 : sizeof(gfx->scroll1x), 0x80000000 | (SF_IS_BOOL(&(gfx->scroll1x)) ? 0x08000000 : 0), "scroll1x" },
      { &(gfx->scroll1y), SF_IS_BOOL(&(gfx->scroll1y)) ? 1 : sizeof(gfx->scroll1y), 0x80000000 | (SF_IS_BOOL(&(gfx->scroll1y)) ? 0x08000000 : 0), "scroll1y" },
      { &(gfx->scroll2x), SF_IS_BOOL(&(gfx->scroll2x)) ? 1 : sizeof(gfx->scroll2x), 0x80000000 | (SF_IS_BOOL(&(gfx->scroll2x)) ? 0x08000000 : 0), "scroll2x" },
      { &(gfx->scroll2y), SF_IS_BOOL(&(gfx->scroll2y)) ? 1 : sizeof(gfx->scroll2y), 0x80000000 | (SF_IS_BOOL(&(gfx->scroll2y)) ? 0x08000000 : 0), "scroll2y" },
      { &(gfx->scrollsprx), SF_IS_BOOL(&(gfx->scrollsprx)) ? 1 : sizeof(gfx->scrollsprx), 0x80000000 | (SF_IS_BOOL(&(gfx->scrollsprx)) ? 0x08000000 : 0), "scrollsprx" },
      { &(gfx->scrollspry), SF_IS_BOOL(&(gfx->scrollspry)) ? 1 : sizeof(gfx->scrollspry), 0x80000000 | (SF_IS_BOOL(&(gfx->scrollspry)) ? 0x08000000 : 0), "scrollspry" },
      { &(gfx->planeSwap), SF_IS_BOOL(&(gfx->planeSwap)) ? 1 : sizeof(gfx->planeSwap), 0x80000000 | (SF_IS_BOOL(&(gfx->planeSwap)) ? 0x08000000 : 0), "planeSwap" },
      { &(gfx->bgc), SF_IS_BOOL(&(gfx->bgc)) ? 1 : sizeof(gfx->bgc), 0x80000000 | (SF_IS_BOOL(&(gfx->bgc)) ? 0x08000000 : 0), "bgc" },
      { &(gfx->oowc), SF_IS_BOOL(&(gfx->oowc)) ? 1 : sizeof(gfx->oowc), 0x80000000 | (SF_IS_BOOL(&(gfx->oowc)) ? 0x08000000 : 0), "oowc" },

      { &(gfx->negative), SF_IS_BOOL(&(gfx->negative)) ? 1 : sizeof(gfx->negative), 0x80000000 | (SF_IS_BOOL(&(gfx->negative)) ? 0x08000000 : 0), "negative" },
